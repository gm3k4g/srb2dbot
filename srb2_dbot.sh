...
LUA_WAD="$SCRIPT_DIR/scripts/SRB2DiscordBot-v0.1.46.lua"
if [[ ! -f "$LUA_WAD" ]]; then
    echo "ERROR: SRB2DiscordBot-v0.1.46.lua not found at $LUA_WAD" >&2
    exit 1
fi
...
cp "$LUA_WAD" "$SRB2_DATA_DIR/DOWNLOAD/SRB2DiscordBot-v0.1.46.lua"
...
HOME="$SRB2_SERVER_HOME" exec srb2 \
    ...
    -warp MAPF0 \
    -gametype 7 \
    -file "$SRB2_DATA_DIR/DOWNLOAD/SRB2DiscordBot-v0.1.46.lua" \
