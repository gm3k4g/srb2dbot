...
| Page | Description |
|---|---|---|
| [index.html](doc/index.html) | Project overview, quick start, deployment (Docker portable build), features at a glance, security model, dependencies |
| [commands.html](doc/commands.html) | Complete slash command reference with parameters and behavior |
| [building.html](doc/building.html) | Build instructions for NixOS and Linux, dependency installation, CMake presets, Docker portable build for Debian 12 |
...
| [tools.html](doc/tools.html) | Reference for companion bash scripts (docker-build.sh, thumbnail grabber, intermission overlay generator, build.sh) |
