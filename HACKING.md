...
hidden if the `srb2dbot_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `srb2dbot_DEVELOPER_MODE` to the configure
...
Runs the executable target `srb2dbot_exe`.
